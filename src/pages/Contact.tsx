            ...
            <div className="lg:col-span-2 bg-white p-8 rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100">
              ...
              <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  <button type="button" className="bg-sirver-secondary hover:bg-sirver-primary text-white py-4 px-8 rounded-lg font-bold w-full transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center gap-2">
                    MESAJI GÖNDER <Send size={18} />
                  </button>
                </div>
              </form>
            </div>
