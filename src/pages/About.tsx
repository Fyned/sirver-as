  ...
  return (
    <>
      ...
      <main className="pt-32 pb-0">
        ...
        {/* 2. SAYILARLA BİZ */}
        <section className="bg-sirver-secondary text-white py-16 mb-20">
          <div className="container mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/10">
            <div>
              <div className="text-4xl md:text-5xl font-heading font-bold text-sirver-accent mb-2">25+</div>
              <div className="text-sm text-gray-400 uppercase tracking-wider">Yıllık Tecrübe</div>
            </div>
            <div>
              <div className="text-4xl md:text-5xl font-heading font-bold text-sirver-primary mb-2">1.2M</div>
              <div className="text-sm text-gray-400 uppercase tracking-wider">Yıllık Ton Kapasite</div>
            </div>
            <div>
              <div className="text-4xl md:text-5xl font-heading font-bold text-blue-400 mb-2">50+</div>
              <div className="text-sm text-gray-400 uppercase tracking-wider">Araç Filosu</div>
            </div>
            <div>
              <div className="text-4xl md:text-5xl font-heading font-bold text-white mb-2">%100</div>
        ...
        <section className="container mx-auto px-4 mb-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-soft border-t-4 border-sirver-primary hover:-translate-y-1 transition-transform">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-soft border-t-4 border-sirver-accent hover:-translate-y-1 transition-transform">
